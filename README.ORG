...
* The How-to
  Simply unzip the ogg files from Lee Jackson's pack into the `highres/tanktracks/` folder. Remove the placeholder file when you do so. Zip up the two defs and the highres folder into a simple zip, perhaps named `tanktracks.zip`. Drop it in your eDuke32 'autoload' folder.
